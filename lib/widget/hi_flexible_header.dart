...
class _HiFlexibleHeaderState extends State<HiFlexibleHeader> {
  static const double MAX_BOTTOM = 40; // 距离底部最大的距离；
  static const double MIN_BOTTOM = 10; // 距离底部最小的距离；

  //滚动范围
  static const MAX_OFFSET = 80;
  double _dyBottom = MAX_BOTTOM; // 动态的位移

  @override
  void initState() {
    super.initState();
    widget.controller.addListener(() {
      var offset = widget.controller.offset; // 列表滚动时获取实时位移
      print('offset:$offset');
      //算出padding变化系数0-1
